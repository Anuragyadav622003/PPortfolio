...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const SERVICE_ID = "service_78bq4cf"; // Your EmailJS service ID
    const TEMPLATE_ID = "template_p04pksk"; // Your EmailJS template ID
    const PUBLIC_KEY = "TxceL7FSRZLxJjIYs"; // Your EmailJS public key
